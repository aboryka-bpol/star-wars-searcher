...
export const fetchVehiclesSuccess = (vehicles: IVehicle[], prev: string, next: string): IFetchVehiclesSuccess => {
    return {
...
export type VehiclesAction = IFetchVehicles | IFetchVehiclesSuccess | IFetchVehiclesFailure;
