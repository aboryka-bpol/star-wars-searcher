...
export const fetchSpeciesSuccess = (species: ISpecies[], prev: string, next: string): IFetchSpeciesSuccess => {
    return {
...
export type SpeciesAction = IFetchSpecies | IFetchSpeciesSuccess | IFetchSpeciesFailure;
